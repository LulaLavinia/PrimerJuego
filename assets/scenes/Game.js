...
export default class Game extends Phaser.Scene {
    ...
    init() {
        ...
        this.shapesRecolected = {
            ...
            [DOLAR]: { count: 0, score: 60, },
            [PESO]: { count: 0, score: -60, },
    ...
    create() {
        ...
        platforms.create(412, 300, "ground").setScale(1).refreshBody();
    ...
    addShape() {
        //get random shape
        const randomShape = Phaser.Math.RND.pick([DIAMOND, SQUARE, TRIANGLE, REDTRIANGLE, DOLAR, PESO]);
